...
|---|---|---|---|
| Mantener mis datos de contacto | — | Necesito que puedan identificarme y contactarme. | nombre, email |
...
| Marcar una notificación como leída | Notificacion | Confirmo la lectura para que quede trazabilidad de recepción. | — |
